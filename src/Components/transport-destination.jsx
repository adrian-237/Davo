...
export default function TransportDestination({ country, image, destinations }) {
    return (
        <div className="rounded-lg w-[292px]">
            ...
            <div className="text-center font-bold uppercase text-base mt-2 text-primary flex justify-between md:text-2xl">{country} <div className="text-base text-[#6985A2] normal-case font-normal">Rezervă Loc</div></div>
